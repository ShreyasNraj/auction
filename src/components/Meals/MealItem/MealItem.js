...
const MealItem = (props) => {
  ...
  const price = `Base Price:Rs.${props1.price.toFixed(2)}`;
  ...
  return (
      ...
      <Timer due={props1.due}/>
        ...
        <MealItemForm onAddToCart={addToCartHandler} price={props1.price.toFixed(0)} onPriceUpdate={priceUpdateHandler} upPrice={upPrice} />
